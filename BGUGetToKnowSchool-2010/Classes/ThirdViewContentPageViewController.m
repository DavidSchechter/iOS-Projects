//
//  ThirdViewContentPageViewController.m
//  BguWhereIsIt
//
...
@implementation ThirdViewContentPageViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
	UIColor *background = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"super.png"]];
