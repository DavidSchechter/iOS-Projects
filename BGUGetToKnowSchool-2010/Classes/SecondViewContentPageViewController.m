//
//  SecondViewContentPageViewController.m
//  BguWhereIsIt
//
...
@implementation SecondViewContentPageViewController


@synthesize washerName;
@synthesize address;
@synthesize location;
@synthesize addText;
@synthesize phones;
...
- (void)viewDidLoad {
    [super viewDidLoad];
	UIColor *background = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"washer.png"]];
