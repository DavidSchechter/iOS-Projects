...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CategoryMemberViewController *masterViewController = [[[CategoryMemberViewController alloc] initWithNibName:@"CategoryMemberViewController" bundle:nil] autorelease];
